...
export default function App() {
  ...
  if (fullscreenLost && hasEnteredRef.current && stage !== STAGES.LEVEL2) {
    return (
  ...
  return (
    <div className="app-root">
      ...
      {stage === STAGES.VIDEO_ENTRY && (
        <VideoPlayer
          src="/src/assets/Entry.mp4"
          onEnd={handleEntryVideoEnd}
        />
      )}
      {stage === STAGES.VIDEO_TRANSITION && (
        <VideoPlayer
          src="/src/assets/Trinetra.mp4"
          onEnd={handleTransitionVideoEnd}
        />
      )}
      {stage === STAGES.LEVEL1 && <Level1 onComplete={handleLevel1Complete} />}

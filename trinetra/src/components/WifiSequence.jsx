...
const WIFI_NETWORKS = [
  { id: "iitt_free",  ssid: "IITT",         secured: false, signal: 4, note: "Free" },
  { id: "iitt_pass",  ssid: "IITT",         secured: true,  signal: 3, note: "Password protected" },
...
export default function WifiSequence({ coins, password, onDone }) {
  ...
  const handlePayConfirm = () => {
    if (payStep < 2) {
      ...
      setNarratorLines([
        ...
        "...",
        "Good job.",
        "If you had connected to the free IITT Wi-Fi, your device details, session tokens, and identity could have been silently harvested.",
  ...
  return (
    <div className="wifi-seq-root">
      ...
      <img src="/src/assets/placeholder.png" alt="" className="ws-wallpaper" />

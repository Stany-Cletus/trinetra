...
function buildMap() {
  ...
  // Ground + reachable platforms. The largest normal vertical jump is 3 tiles.
  fill(14, 0, 79);
  ...
  // Pit + stepping stone
  for (let r = 13; r <= 14; r++) for (let c = 17; c <= 21; c++) map[r][c] = 0;
  fill(12, 18, 19);

  // Zone 2: alternating platforms
  fill(11, 23, 27);
  fill(9, 28, 32);
  fill(11, 33, 37);
  fill(9, 38, 42);
...
const LETTER_PICKUPS = [
  { id: 0, letter: "T", x: 5 * TILE,  y: 10 * TILE - 32 },
  { id: 1, letter: "R", x: 8 * TILE,  y: 8 * TILE - 32 },
  { id: 2, letter: "I", x: 18 * TILE, y: 12 * TILE - 32 },
  { id: 3, letter: "N", x: 30 * TILE, y: 9 * TILE - 32 },
  { id: 4, letter: "E", x: 40 * TILE, y: 9 * TILE - 32 },
  { id: 5, letter: "T", x: 54 * TILE, y: 11 * TILE - 32 },
  { id: 6, letter: "R", x: 68 * TILE, y: 8 * TILE - 32 },
  { id: 7, letter: "A", x: 77 * TILE, y: 12 * TILE - 32 },
];

// ── Finish line ────────────────────────────────────────────────────────────
const FINISH = { x: 78 * TILE, y: 8 * TILE, w: 40, h: TILE * 6 };
